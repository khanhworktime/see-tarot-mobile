...
| # | Phase | Status | Output |
|---|-------|--------|--------|
| 01 | [Reading API surface + stores](phase-01-reading-api-and-stores.md) | pending | APIClient reading methods, Daily/Oracle stores + tests |
| 02 | [Card flip animation](phase-02-card-flip-animation.md) | pending | Real CardSurface (Core Animation) replacing placeholder |
| 03 | [Reading UI screens](phase-03-reading-ui-screens.md) | pending | Home daily section, Oracle form, Reading view, QuotaChip |
